...
export type PlasmicCommentCloudSection__VariantMembers = {};
export type PlasmicCommentCloudSection__VariantsArgs = {};
type VariantPropType = keyof PlasmicCommentCloudSection__VariantsArgs;
export const PlasmicCommentCloudSection__VariantProps =
  new Array<VariantPropType>();

export type PlasmicCommentCloudSection__ArgsType = {};
type ArgPropType = keyof PlasmicCommentCloudSection__ArgsType;
export const PlasmicCommentCloudSection__ArgProps = new Array<ArgPropType>();

export type PlasmicCommentCloudSection__OverridesType = {
  root?: p.Flex<"div">;
};

export interface DefaultCommentCloudSectionProps {
  className?: string;
}
...
function PlasmicCommentCloudSection__RenderFunc(props: {
  variants: PlasmicCommentCloudSection__VariantsArgs;
  args: PlasmicCommentCloudSection__ArgsType;
  overrides: PlasmicCommentCloudSection__OverridesType;
  forNode?: string;
}) {
...
type NodeOverridesType<T extends NodeNameType> = Pick<
  PlasmicCommentCloudSection__OverridesType,
  DescendantsType<T>
>;
type NodeComponentProps<T extends NodeNameType> =
  ...
  } & Omit<PlasmicCommentCloudSection__VariantsArgs, ReservedPropsType> & // Specify variants directly as props
    /* Specify args directly as props*/ Omit<
      PlasmicCommentCloudSection__ArgsType,
      ReservedPropsType
    > &
